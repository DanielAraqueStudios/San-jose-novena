...
document.addEventListener("DOMContentLoaded", () => {
    const tabBtns = document.querySelectorAll(".novena-tab-btn");
    const panes = document.querySelectorAll(".novena-pane");
    ...
    if (tabBtns.length > 0 && panes.length > 0) {
        tabBtns.forEach(btn => {
            btn.addEventListener("click", () => {
                ...
                const targetPane = document.getElementById("day-" + dayId);
                if (targetPane) {
